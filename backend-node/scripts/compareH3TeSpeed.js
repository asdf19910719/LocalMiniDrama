...
const DEFAULT_TEST_PROMPT = 'A fast but clearly staged martial-arts action. The same warrior rises, briefly settles, turns, and performs one clean sword swing while the camera remains locked.';
...
async function main(argv = process.argv.slice(2)) {
  ...
  const input = {
    prompt: enforceCrispMotionPrompt(args.prompt || DEFAULT_TEST_PROMPT),
