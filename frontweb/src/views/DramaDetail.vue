<template>
  <div class="drama-detail">
    ...
    <ImageGenerationDrawer
      ...
      :environment="imageGeneration.environment"
      @close="imageGeneration.close"
      @check-environment="imageGeneration.checkEnvironment({ dramaId, channel: imageGenerationDefaultChannel, targetType: imageGenerationTask?.target_type, targetId: imageGenerationTask?.target_id }, { force: true })"
