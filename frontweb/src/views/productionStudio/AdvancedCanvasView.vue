<template>
  <div style="display:flex; flex-direction:column; height:100vh">
    <header class="page-head">
      ...
      <span class="badge outline">OPTIONAL · 标准页数据的投影</span>
    </header>
    <div class="page-body" style="display:flex; gap:14px; overflow:auto">
      <div class="card grow" style="position:relative; min-height:480px; overflow:hidden">
        <svg style="width:100%; height:100%" viewBox="0 0 900 480" preserveAspectRatio="xMidYMid meet">
          ...
          <!-- 场景 → 分镜（生成=蓝） -->
          <line x1="520" y1="60" x2="640" y2="120" stroke="var(--info)" stroke-width="1.4" marker-end="url(#arrow)"/>
          <!-- 角色 → 分镜（生成=蓝） -->
          <line x1="520" y1="140" x2="640" y2="140" stroke="var(--info)" stroke-width="1.4" marker-end="url(#arrow)"/>
          <!-- 分镜 → 候选（生成=蓝） -->
          <line x1="730" y1="140" x2="790" y2="220" stroke="var(--info)" stroke-width="1.4" marker-end="url(#arrow)"/>
          <!-- 候选 → 成片 -->
          <line x1="790" y1="260" x2="700" y2="340" stroke="var(--info)" stroke-width="1.4" marker-end="url(#arrow)"/>
          <!-- 过期关系（虚线） -->
          <line x1="240" y1="90" x2="700" y2="340" stroke="var(--warn)" stroke-width="1.2" stroke-dasharray="5 4"/>
          <text x="330" y="240" fill="var(--warn)" font-size="11">剧本更新 → 成片待复核</text>
      ...
      <div class="col" style="width:260px; flex:0 0 260px; gap:10px">
        ...
        <div class="card pad">
          ...
          <div class="kv"><span class="k">— 实线灰</span><span class="v">引用</span></div>
          <div class="kv"><span class="k">— 实线蓝</span><span class="v">生成</span></div>
          <div class="kv"><span class="k">- - 虚线黄</span><span class="v">过期</span></div>
        </div>
      </div>
    </div>
  </div>
