...
/** 仅 legacy:本地"缺图跳过"口径,与后端槽位(缺图占位不重排)不一致;仅作粗筛与非 H3 槽位接口失败兜底,提交一律走 collectSlotReferenceAbsoluteUrls */
...
async function onGenerateSbVideo(sb) {
  ...
  if (omniRefs === null) return // H3:槽位失败已提示,中止提交,绝不降级 legacy 参考图
