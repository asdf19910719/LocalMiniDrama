...
export const generationStyleOptions = [
  {
    ...
    options: [
      ...
      { label: '电影感',  value: 'cinematic',
        prompt:   '电影级大片画面，变形镜头压缩感，胶片颗粒质感，伦勃朗式戏剧性布光，景深随镜头叙事动态选择，双人及多人镜头中所有主要人物面部保持清晰可辨，专业调色风格，史诗级构图，35mm胶片美学，宽画幅银幕比例',
        promptEn: 'cinematic movie still, anamorphic lens, film grain, dramatic rembrandt lighting, shot-appropriate depth of field, all principal characters\' faces sharply focused and clearly identifiable in two-shots and group shots, color graded, epic composition, professional cinematography, 35mm film, widescreen',
