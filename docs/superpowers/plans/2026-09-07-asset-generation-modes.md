...
- [x] **Step 1: Write failing mode protocol and persistence tests**
...
- [x] **Step 3: Implement the minimal protocol and migrations**
...
- [x] **Step 1: Write failing route and state-generation tests**
...
- [x] **Step 3: Implement mode dispatch**
...
- [x] **Step 3: Implement trusted backend resolution and persistence**
...
- [x] **Step 1: Write failing execution-wrapper tests**
...
- [x] **Step 3: Implement reference-aware wrapping**
...
- [x] **Step 3: Implement selectors and optimistic persistence**
...
- [x] **Step 1: Add the verified user-visible changelog entry**
...
- [x] **Step 2: Run backend targeted regressions**
...
- [x] **Step 3: Run complete frontend tests and production build**

Run: `node --test test/*.test.js`

Run: `npm run build`

- [x] **Step 4: Check diff hygiene and conduct code review**

Run: `git diff --check`

Review validation boundaries, defaults, route compatibility, identity reference behavior, and unrelated-file exclusion. Fix every actionable finding and repeat affected tests. The final review pass also corrected API submission so an already persisted `prompt_snapshot` is executed verbatim instead of receiving duplicate mode/style instructions.

- [x] **Step 5: Mark plan checkboxes complete and commit**
